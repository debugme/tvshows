    ...
    <header className="bg-slate-700 drop-shadow-2xl flex justify-between px-4">
      ...
      <section className="flex justify-center items-center">
        <Link className="flex relative" to="/">
          ...
          <p className="absolute top-[4px] left-11 bg-clip-text text-transparent bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 pt-2 tracking-[2px] text-sm uppercase">showz</p>
        </Link>
      </section>

...
export const Message: FC<MessageProps> = (props) => {
  ...
  return (
    <section className="p-8 md:p-12 lg:p-20 mt-10 bg-message-bg rounded-xl h-[330px] grid place-content-center cursor-pointer">
      <div className="flex flex-wrap">
        <div className="max-h-[200px]">{children}</div>
        <div className="pr-4 text-message-fg">
